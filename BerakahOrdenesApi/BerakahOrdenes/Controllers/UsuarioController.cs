...
namespace BerakahOrdenes.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public UsuarioController(DBOrdenes db, IUsuarioRolRepository usuarioRolRepository, IUsuarioRepository usuarioRepository, IMapper mapper, IConfiguration config)
        {
